...
<div class="row">
      ...
      <a href="<?php echo site_url('KPembeli/VFormAddPembeli'); ?>" class="btn btn-primary btn-sm fa fa-plus"> Tambah Data</a><br><br>
    ...
    <td><?php echo $ReadDS->tanggal_pembelian; ?></td>
		...
		<td width="5%">
      <a href="<?php echo site_url('KPembeli/DeleteDataPembeli/'.$ReadDS->id_pembeli) ?>">Delete</a>
		</td>
    <td></td>
	</tr>
