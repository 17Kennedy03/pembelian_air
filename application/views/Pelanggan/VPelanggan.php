...
<div class="row">
      ...
      <a href="<?php echo site_url('Pelanggan/VFormAddPelanggan'); ?>" class="btn btn-primary btn-sm fa fa-plus"> Tambah Data</a><br><br>
    ...
    <td><?php echo $ReadDS->alamat; ?></td>
		...
		<td width="5%">
			<a href="<?php echo site_url('Pelanggan/DataPelanggan/'.$ReadDS->id_pelanggan.'/view') ?>">Update</a>
      <td>
