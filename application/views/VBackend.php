...
<head>
  ...
  <title>Aplikasi Depot Air</title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="../../index2.html" class="logo">
      ...
      <span class="logo-lg"><b>Aplikasi Depot Air</b></span>
    </a>
...
<!-- <========================================================================================> -->    
      <ul class="sidebar-menu" data-widget="tree">
       <li class="header">Menu Utama</li>
        ...
        <li><a href="<?php echo site_url('IsiUlang/DataIsiUlang'); ?>"><i class="fa fa-truck"></i> <span>Isi Ulang</span></a></li>

        <li><a href="<?php echo site_url('Pelanggan/DataPelanggan'); ?>"><i class="fa fa-id-card"></i> <span>Pelanggan</span></a></li>

        <li><a href="<?php echo site_url('Pembeli/DataPembeli'); ?>"><i class="fa fa-money"></i> <span>Data Pembeli</span></a></li>


     <?php }elseif ($this->session->userdata('level') == "karyawan"){?>
      <li><a href="<?php echo site_url('Welcome/index'); ?>"><i class="fa fa-dashboard"></i> <span>Dashboard</span></a></li>

      <li><a href="<?php echo site_url('KPelanggan/DataPelanggan'); ?>"><i class="fa fa-id-card"></i> <span>Pelanggan</span></a></li>
      
      <li><a href="<?php echo site_url('KPembeli/DataPembeli'); ?>"><i class="fa fa-money"></i> <span>Data Pembeli</span></a></li>
