...
public function DataPelanggan()
	{
		...
		if($this->uri->segment(4)=='view')
		{
			...
			$data['content']='Pelanggan/VFormUpdatePelanggan';
		}
		else
		{	
			$data['DataPelanggan']=$this->MSudi->GetData('pelanggan');
			$data['content']='Pelanggan/VPelanggan';
		}
	...
	{
		$data['content']='Pelanggan/VFormAddPelanggan';
		$this->load->view('VBackend',$data);
	}
	public function AddDataPelanggan()
	{
        	 ...
        	 redirect(site_url('Pelanggan/DataPelanggan'));
	}
