...
class KPembeli extends CI_Controller {
...
public function DataPembeli()
	{
		...
		if($this->uri->segment(4)=='view')
		{
			...
			$data['content']='LevelKaryawan/VFormUpdatePembeli';
		}
		else
		{	
			$data['DataPembeli']=$this->MPembeli->GetData();
			$data['content']='LevelKaryawan/VPembeli';
		}
	...
	{
		$data['content']='LevelKaryawan/VFormAddPembeli';
	...
	public function AddDataPembeli()
	{
        	 ...
        	 redirect(site_url('KPembeli/DataPembeli'));
	}
